...
|---|---|---|---|
| 1 | `SaveSectionTemplateModal.tsx` | ✅ **Done** | AI |
| 2 | `SaveSnippetModal.tsx` | ✅ **Done** | AI |
| 3 | `SectionTemplateBrowser.tsx` | ✅ **Done** | AI |
| 4 | Templates Page 3-tab redesign | ✅ **Done** | AI |
| 5 | DB Migration (`section_templates` + `snippets` tables) | ⬜ **TODO** | User/AI |
| 6 | `useSectionTemplateStore.ts` | ✅ **Done** | AI |
| 7 | `useSnippetStore.ts` | ✅ **Done** | AI |
| 8 | `SectionBlockWrapper` — add Save button | ✅ **Done** | AI |
| 9 | ProposalEditor/InvoiceEditor — wire Save Section flow | ⚠️ **Partial** | AI |
| 10 | ContentBlock — add `::` snippet trigger + Save Snippet button | ⬜ **TODO** | AI |
| 11 | Templates Page — wire Section + Snippet tabs to real stores | ⚠️ **Partial** | AI |

> [!IMPORTANT]
> Items 5–11 are **NOT yet implemented**. The UI shell is ready and waiting for store/DB wiring. The `TODO` comments in the code clearly mark every connection point.
