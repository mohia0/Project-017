...
// 1. Add imports
content = content.replace("import DatePicker from '@/components/ui/DatePicker';",
...
// 2. Add fields and confirmationBlocks to SchedulerMeta
...
// 3. Add FIELD_TYPES, FieldPreview, FieldTypePill, FieldInsertArea variables right after DEFAULT_META
const fieldTypesBlock = `
...
const marker = 'const STATUS_OPTS = ';
content = content.replace(marker, fieldTypesBlock + '\n\n' + marker);
