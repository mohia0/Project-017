            ...
            <div className="flex-1 flex flex-col overflow-hidden relative z-0 isolate">
                ...
                {!isPreview && (
                    <>
                        <div 
                            className={cn(
                                "hidden md:flex flex-col relative transition-all duration-300 ease-in-out z-50 shrink-0",
                                ...
                                <>
                                    ...
                                    >
                                        <input
                                            ...
                                            onChange={e => updateMeta({ invoiceNumber: e.currentTarget.value })}
            ...
            return (
                <div className="group/hb flex items-start gap-2">
                    {!isPreview && (
                        <select
                            value={block.level || 1}
                            onChange={e => updateBlock(block.id, { level: Number(e.currentTarget.value) as 1|2|3 })}
                            className={cn(
